...
Ensuring that the value of a document is correct during the exection of a case can be an important requirement to validate a process. +
...
A document is retrieved from it's case, no matter if it is archived or not. +
