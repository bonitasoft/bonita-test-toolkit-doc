...
* Class
* link:class-use/StartProcessException.html[Use]
...
+
....
public class StartProcessException
extends RuntimeException
....
+
[.seeLabel]#See Also:#::
  link:../../../../../serialized-form.html#com.bonitasoft.test.toolkit.exception.StartProcessException[Serialized Form]
...
|`StartProcessException​(String message)` | 
|===========================================
+
** [#method.summary]##
+
