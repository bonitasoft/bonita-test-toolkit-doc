...
* Class
* link:class-use/LocalDateInputTypeConverter.html[Use]
...
* All Implemented Interfaces:::
  `InputTypeConverter<LocalDate>`
+

'''''
+
....
public class LocalDateInputTypeConverter
extends Object
implements InputTypeConverter<LocalDate>
....
...
+
....
public LocalDateInputTypeConverter()
....
+
** [#method.detail]##
+
...
[.overrideSpecifyLabel]#Specified by:#::
  `convert` in interface `InputTypeConverter<LocalDate>`
[.throwsLabel]#Throws:#::
