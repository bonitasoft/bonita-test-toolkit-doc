...
* Class
* link:class-use/LongInputTypeConverter.html[Use]
...
* ** com.bonitasoft.test.toolkit.internal.contract.converter.LongInputTypeConverter
...
+
....
public class LongInputTypeConverter
extends Object
