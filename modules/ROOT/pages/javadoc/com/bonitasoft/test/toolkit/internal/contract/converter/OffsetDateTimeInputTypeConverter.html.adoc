...
* Class
* link:class-use/OffsetDateTimeInputTypeConverter.html[Use]
...
* ** com.bonitasoft.test.toolkit.internal.contract.converter.OffsetDateTimeInputTypeConverter

* All Implemented Interfaces:::
  `InputTypeConverter<OffsetDateTime>`
+

'''''
+
....
public class OffsetDateTimeInputTypeConverter
extends Object
implements InputTypeConverter<OffsetDateTime>
....
...
|`OffsetDateTimeInputTypeConverter()` | 
|=======================================
+
** [#method.summary]##
+
...
+
....
public OffsetDateTimeInputTypeConverter()
....
+
** [#method.detail]##
+
...
[.overrideSpecifyLabel]#Specified by:#::
  `convert` in interface `InputTypeConverter<OffsetDateTime>`
[.throwsLabel]#Throws:#::
