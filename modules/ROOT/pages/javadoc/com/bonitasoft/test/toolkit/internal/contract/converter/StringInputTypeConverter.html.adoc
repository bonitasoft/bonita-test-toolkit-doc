...
* Class
* link:class-use/StringInputTypeConverter.html[Use]
...
* ** com.bonitasoft.test.toolkit.internal.contract.converter.StringInputTypeConverter

* All Implemented Interfaces:::
  `InputTypeConverter<String>`
+

'''''
+
....
public class StringInputTypeConverter
extends Object
implements InputTypeConverter<String>
....
...
+
....
public StringInputTypeConverter()
....
+
** [#method.detail]##
+
...
[.overrideSpecifyLabel]#Specified by:#::
  `convert` in interface `InputTypeConverter<String>`
[.throwsLabel]#Throws:#::
