...
* Class
* link:class-use/IntegerInputTypeConverter.html[Use]
...
* ** com.bonitasoft.test.toolkit.internal.contract.converter.IntegerInputTypeConverter

* All Implemented Interfaces:::
  `InputTypeConverter<Integer>`
+

'''''
+
....
public class IntegerInputTypeConverter
extends Object
implements InputTypeConverter<Integer>
....
...
+
....
public IntegerInputTypeConverter()
....
+
** [#method.detail]##
+
...
[.overrideSpecifyLabel]#Specified by:#::
  `convert` in interface `InputTypeConverter<Integer>`
[.throwsLabel]#Throws:#::
