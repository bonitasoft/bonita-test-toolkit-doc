...
Read the xref:bonita:setup-dev-environment:configure-maven.adoc#repositories[Configure repositories section] to see how to configure your Maven settings in order to access to Bonita Artifact Repository.
