...
== Installation from the Bonita Artifact Repository
                                        xref:version@component:module:target-page-filename.adoc
...
Read the xref:bonita:software-extensibility:bonita-repository-access.adoc#maven[Maven section] to see how to configure your Maven settings in order to access to Bonita Artifact Repository.
